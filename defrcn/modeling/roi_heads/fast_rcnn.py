...
def fast_rcnn_inference(
    boxes, scores,image_shapes, score_thresh, nms_thresh, topk_per_image,scores1
):
    """
    ...
    result_per_image = [
        ...
        # )
        for scores_per_image, boxes_per_image, image_shape,scores1_per_image in zip(
            scores, boxes, image_shapes,scores1
        )
    ]
...
def fast_rcnn_inference_single_image(
    boxes, scores, image_shape, score_thresh, nms_thresh, topk_per_image,scores1
):
    """
...
class FastRCNNOutputs(object):
    ...
    def __init__(
        ...
        self.pred_class_logits_new = pred_class_logits_new
    ...
    def softmax_cross_entropy_loss_sub(self,new_feature):
        """
        Compute the softmax cross entropy loss for box classification.
        ...
        self._log_accuracy()
        return F.cross_entropy(
            new_feature, self.gt_classes, reduction="mean"
        )
    ...
    def predict_probs(self):
        ...
        Returns:
            list[Tensor]: A list of Tensors of predicted class probabilities for each image.
                ...
                for image i.
        """
        probs1 = F.softmax(self.pred_class_logits, dim=-1)
        probs2 = F.softmax(self.pred_class_logits_new, dim=-1)
        return probs1.split(self.num_preds_per_image, dim=0),probs2.split(self.num_preds_per_image, dim=0)
    ...
    def inference(self, score_thresh, nms_thresh, topk_per_image):
        ...
        scores,scores1= self.predict_probs()
